...
@section('content')
    ...
    <section class="section dashboard">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Stock Paper Details</h5>
                <div class="container-fluid bg-white shadow-sm rounded">
                    ...
                    <div class="row mb-4 align-items-end">
                        ...
                        <div class="col-md-6">
                            <label for="vehicleSearch" class="form-label fw-bold text-secondary">Search Vehicle
                                Number:</label>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-preview', function() {
                ...
                if (['jpg', 'jpeg', 'png', 'gif', 'webp'].includes(fileType)) {
                    ...
                    htmlContent = '<iframe src="' + fileUrl +
