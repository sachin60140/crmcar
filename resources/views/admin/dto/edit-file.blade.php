    ...
    <section class="section dashboard">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <!-- Multi Columns Form -->
                <form class="row g-3" action="{{url('admin/dto/update-dto-file/'.$getRecord->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="Text" style="background-color: #8d9797;" readonly class="form-control" id="rto_location" value="{{$getRecord->rto_location}}"
                            name="rto_location" required>
                    </div>
                   
                    <div class="col-md-4">
                        <label for="mobile_number" class="form-label">File Uploaded by <span style="color: red;">*</span></label>
                        <input type="Text" style="background-color: #8d9797;" readonly class="form-control" id="inputName5" value="{{$getRecord->created_by}}"
                            name="created_by" required>
                    </div>
                    <div class="col-4">
                        <label for="inputAddress2" class="form-label">Uploaded Date</label>
                        <input type="text" style="background-color: #8d9797;" readonly class="form-control" id="address" name="created_at"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="Text" style="background-color: #8d9797;" readonly class="form-control" id="inputName5" value="{{$getRecord->updated_by}}"
                    ...
                    <div class="col-md-4" id="online_div" style="display: none;">
                        <label for="online_date" class="form-label">Online Date <span style="color: red;">*</span></label>
                        <input type="date" class="form-control" id="online_date" value="{{ old('online_date')}}"
                            name="online_date">
                    </div>
                    <div class="col-4" id="mparivahan" style="display: none;">
                        <label for="upload_mparivahan" class="form-label">Upload M-Parivahan <span style="color: red;">*</span></label>
                        <input type="file" class="form-control" id="upload_mparivahan" value="{{ old('upload_mparivahan') }}"
                            name="upload_mparivahan">
                    </div>
                    <div class="col-md-4" >
