            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" style="text-transform:uppercase" id="car_number" name="car_number"
                            placeholder="Enter Registration Number" value="{{ old('car_number') }}" required>
                    </div>
