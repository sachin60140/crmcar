                            ...
                            <tbody>
                                @foreach ($qkonnect_Data as $items)
                                    <tr>
                                        ...
                                        <td>{{ $items->total_call_time }}</td>
                                        <td>{{ $items->agent_number }}</td>
                                        <td><a href=" {{$items->call_recording}}" target="_blank">Recording</a></td>
                                        <td>{{ date('d-m-Y h:i:sa', strtotime($items->created_at)) }}
                                        </td>
                                    </tr>
                                @endforeach
