    ...
    <div class="row align-items-end g-2">
        ...
        <div class="col-md-1">
            ...
            <select name="call_status" class="form-control">
                ...
                <option value="answered" {{ request('call_status')=='answered'?'selected':'' }}>Ans</option>
                <option value="missed" {{ request('call_status')=='missed'?'selected':'' }}>Miss</option>
            </select>
        </div>
        ...
        <div class="col-md-1">
            ...
            <select name="direction" class="form-control">
                ...
                <option value="outbound" {{ request('direction')=='outbound'?'selected':'' }}>Out</option>
            </select>
        </div>
        ...
        <div class="col-md-1">
            <a href="{{ route('showacephonedata') }}" class="btn btn-secondary w-100">Reset</a>
        </div>
