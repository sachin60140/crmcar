                        ...
                        <form class="row g-3" action="{{ route('storefinancefiledetails') }}" method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="Text" class="form-control" id="se_mobile"
                                    value="{{ old('se_mobile') }}" name="se_mobile" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="Text" class="form-control" id="sold_amount"
                                    value="{{ old('sold_amount') }}" name="sold_amount" required>
                            </div>
                            <div class="col-md-12">
