...
@section('title', 'Add Visitor | Car 4 Sale')
            ...
            <div class="col-md-6 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Multi Columns Form -->
                        <form class="row g-3" action="{{route('addvisitor')}}" method="POST">
                            @csrf
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <label for="fee" class="form-label">Car Details <span style="color: red;">*</span></label>
                                <input type="text" class="form-control" id="cab_fee" value="{{ old('car_require') }}"
                                    name="car_require">
                            </div>
                            ...
                            <div class="col-md-12">
                                <label for="fee" class="form-label">Refrence <span style="color: red;">*</span></label>
                                <input type="text" class="form-control" id="refrence" value="{{ old('refrence') }}"
                                    name="refrence">
                            </div>
